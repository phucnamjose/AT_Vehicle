...
#define	HEADING_OFFSET_LIDAR				(0.0)
...
#define LEVEL_ACTIVE_LS_UP_NEG				(1)
...
#define	HARD_LIM_DOWN_NEG					(-1.570796327) // -pi/2

#define	SOFT_LIM_UP_NEG						(-2.00712864) // range 34 deg
#define	SOFT_LIM_UP_POS						(-1.406058617)

#define	SOFT_LIM_DOWN_NEG					(-1.483529864) // range 170 deg
#define	SOFT_LIM_DOWN_POS					(1.483529864)
