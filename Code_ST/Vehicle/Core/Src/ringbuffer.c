...
RingBuffer_t ringbuff_rx_debug 	= {{0}, 0, 0, FALSE, TRUE};
RingBuffer_t ringbuff_rx_pi		= {{0}, 0, 0, FALSE, TRUE};
RingBuffer_t ringbuff_rx_mega 	= {{0}, 0, 0, FALSE, TRUE};
RingBuffer_t ringbuff_tx_pi		= {{0}, 0, 0, FALSE, TRUE};
RingBuffer_t ringbuff_tx_mega	= {{0}, 0, 0, FALSE, TRUE};
